...
unsigned int WINAPI CMainFrame::SendThread(void* pParam)
{
	...
	if(hHttpOpen)
	{
		HINTERNET hHttpConn = InternetConnect(hHttpOpen, L"pc.xyzs.com" ,INTERNET_DEFAULT_HTTP_PORT,NULL,NULL,INTERNET_SERVICE_HTTP,NULL,NULL);
		if(hHttpConn)
		{
			wstring szBugReportLink = L"/client/uploadZip/breakdown";
